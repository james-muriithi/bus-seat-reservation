...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.system-settings.update", [$systemSetting->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="default_currency_id">{{ trans('cruds.systemSetting.fields.default_currency') }}</label>
                <select class="form-control select2 {{ $errors->has('default_currency') ? 'is-invalid' : '' }}" name="default_currency_id" id="default_currency_id" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company_name') ? 'is-invalid' : '' }}" type="text" name="company_name" id="company_name" value="{{ old('company_name', $systemSetting->company_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('smtp_username') ? 'is-invalid' : '' }}" type="text" name="smtp_username" id="smtp_username" value="{{ old('smtp_username', $systemSetting->smtp_username) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('smtp_host') ? 'is-invalid' : '' }}" type="text" name="smtp_host" id="smtp_host" value="{{ old('smtp_host', $systemSetting->smtp_host) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('smtp_password') ? 'is-invalid' : '' }}" type="text" name="smtp_password" id="smtp_password" value="{{ old('smtp_password', $systemSetting->smtp_password) }}">
