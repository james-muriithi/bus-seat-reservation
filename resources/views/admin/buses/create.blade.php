    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.buses.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bus_name') ? 'is-invalid' : '' }}" type="text" name="bus_name" id="bus_name" value="{{ old('bus_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bus_reg_no') ? 'is-invalid' : '' }}" type="text" name="bus_reg_no" id="bus_reg_no" value="{{ old('bus_reg_no', '') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('bus_type') ? 'is-invalid' : '' }}" name="bus_type_id" id="bus_type_id" required>
                    @foreach($bus_types as $id => $entry)
                        <option value="{{ $id }}" {{ old('bus_type_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_seats') ? 'is-invalid' : '' }}" type="number" name="max_seats" id="max_seats" value="{{ old('max_seats', '') }}" step="1" required>
