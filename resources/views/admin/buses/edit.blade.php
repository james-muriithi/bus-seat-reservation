    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.buses.update", [$bus->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bus_name') ? 'is-invalid' : '' }}" type="text" name="bus_name" id="bus_name" value="{{ old('bus_name', $bus->bus_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bus_reg_no') ? 'is-invalid' : '' }}" type="text" name="bus_reg_no" id="bus_reg_no" value="{{ old('bus_reg_no', $bus->bus_reg_no) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('bus_type') ? 'is-invalid' : '' }}" name="bus_type_id" id="bus_type_id" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_seats') ? 'is-invalid' : '' }}" type="number" name="max_seats" id="max_seats" value="{{ old('max_seats', $bus->max_seats) }}" step="1" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('status') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="status" id="status" value="1" {{ $bus->status || old('status', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="status">{{ trans('cruds.bus.fields.status') }}</label>
                </div>
...
Dropzone.options.imagesDropzone = {
    url: '{{ route('admin.buses.storeMedia') }}',
    maxFilesize: 2, // MB
