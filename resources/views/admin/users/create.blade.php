        ...
        <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_admin') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_admin" id="is_admin" value="1" {{ old('is_admin', 0) == 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="is_admin">{{ trans('cruds.user.fields.is_admin') }}</label>
                </div>
