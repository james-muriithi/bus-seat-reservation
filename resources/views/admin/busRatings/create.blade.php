...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.bus-ratings.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="bus_quality">{{ trans('cruds.busRating.fields.bus_quality') }}</label>
                <input class="form-control {{ $errors->has('bus_quality') ? 'is-invalid' : '' }}" type="number" name="bus_quality" id="bus_quality" value="{{ old('bus_quality', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('punctuality') ? 'is-invalid' : '' }}" type="number" name="punctuality" id="punctuality" value="{{ old('punctuality', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('staff_behaviour') ? 'is-invalid' : '' }}" type="number" name="staff_behaviour" id="staff_behaviour" value="{{ old('staff_behaviour', '') }}" step="1">
