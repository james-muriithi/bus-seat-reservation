    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.routes.update", [$route->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('board_point') ? 'is-invalid' : '' }}" type="text" name="board_point" id="board_point" value="{{ old('board_point', $route->board_point) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('board_time') ? 'is-invalid' : '' }}" type="text" name="board_time" id="board_time" value="{{ old('board_time', $route->board_time) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('drop_point') ? 'is-invalid' : '' }}" type="text" name="drop_point" id="drop_point" value="{{ old('drop_point', $route->drop_point) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('drop_time') ? 'is-invalid' : '' }}" type="text" name="drop_time" id="drop_time" value="{{ old('drop_time', $route->drop_time) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fare') ? 'is-invalid' : '' }}" type="number" name="fare" id="fare" value="{{ old('fare', $route->fare) }}" step="0.01" required>
                @if($errors->has('fare'))
                    <div class="invalid-feedback">
                        {{ $errors->first('fare') }}
                    </div>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('status') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="status" id="status" value="1" {{ $route->status || old('status', 0) === 1 ? 'checked' : '' }}>
