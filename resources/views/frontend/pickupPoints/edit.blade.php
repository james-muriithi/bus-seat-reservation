    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.pickup-points.update", [$pickupPoint->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="pickup_point">{{ trans('cruds.pickupPoint.fields.pickup_point') }}</label>
                            <input class="form-control" type="text" name="pickup_point" id="pickup_point" value="{{ old('pickup_point', $pickupPoint->pickup_point) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="pickup_time" id="pickup_time" value="{{ old('pickup_time', $pickupPoint->pickup_time) }}" required>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="status" id="status" value="1" {{ $pickupPoint->status || old('status', 0) === 1 ? 'checked' : '' }}>
                                <label for="status">{{ trans('cruds.pickupPoint.fields.status') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="landmark" id="landmark" value="{{ old('landmark', $pickupPoint->landmark) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="address" id="address" value="{{ old('address', $pickupPoint->address) }}">
