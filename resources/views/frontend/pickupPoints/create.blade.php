        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.create') }} {{ trans('cruds.pickupPoint.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.pickup-points.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="pickup_point">{{ trans('cruds.pickupPoint.fields.pickup_point') }}</label>
                            <input class="form-control" type="text" name="pickup_point" id="pickup_point" value="{{ old('pickup_point', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="pickup_time" id="pickup_time" value="{{ old('pickup_time') }}" required>
