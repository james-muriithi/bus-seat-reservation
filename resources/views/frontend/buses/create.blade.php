    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.buses.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="bus_name">{{ trans('cruds.bus.fields.bus_name') }}</label>
                            <input class="form-control" type="text" name="bus_name" id="bus_name" value="{{ old('bus_name', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="bus_reg_no" id="bus_reg_no" value="{{ old('bus_reg_no', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="max_seats" id="max_seats" value="{{ old('max_seats', '') }}" step="1" required>
