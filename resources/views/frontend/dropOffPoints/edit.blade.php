    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.drop-off-points.update", [$dropOffPoint->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="drop_off_point">{{ trans('cruds.dropOffPoint.fields.drop_off_point') }}</label>
                            <input class="form-control" type="text" name="drop_off_point" id="drop_off_point" value="{{ old('drop_off_point', $dropOffPoint->drop_off_point) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="drop_time" id="drop_time" value="{{ old('drop_time', $dropOffPoint->drop_time) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="landmark" id="landmark" value="{{ old('landmark', $dropOffPoint->landmark) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="address" id="address" value="{{ old('address', $dropOffPoint->address) }}">
