    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.system-settings.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="smtp_username" id="smtp_username" value="{{ old('smtp_username', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="smtp_host" id="smtp_host" value="{{ old('smtp_host', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="smtp_password" id="smtp_password" value="{{ old('smtp_password', '') }}">
