    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.bus-ratings.update", [$busRating->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="bus_quality">{{ trans('cruds.busRating.fields.bus_quality') }}</label>
                            <input class="form-control" type="number" name="bus_quality" id="bus_quality" value="{{ old('bus_quality', $busRating->bus_quality) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="punctuality" id="punctuality" value="{{ old('punctuality', $busRating->punctuality) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="staff_behaviour" id="staff_behaviour" value="{{ old('staff_behaviour', $busRating->staff_behaviour) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="comment" id="comment">{{ old('comment', $busRating->comment) }}</textarea>
