    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.routes.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="board_point" id="board_point" value="{{ old('board_point', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="board_time" id="board_time" value="{{ old('board_time') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="drop_point" id="drop_point" value="{{ old('drop_point', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="fare" id="fare" value="{{ old('fare', '') }}" step="0.01" required>
                            @if($errors->has('fare'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('fare') }}
                                </div>
