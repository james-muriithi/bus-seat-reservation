    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.bus-types.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="bus_type">{{ trans('cruds.busType.fields.bus_type') }}</label>
                            <input class="form-control" type="text" name="bus_type" id="bus_type" value="{{ old('bus_type', '') }}" required>
