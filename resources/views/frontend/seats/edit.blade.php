                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.seats.update", [$seat->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="row" id="row" value="{{ old('row', $seat->row) }}" step="1" required>
                            @if($errors->has('row'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('row') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="column" id="column" value="{{ old('column', $seat->column) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $seat->name) }}">
                            @if($errors->has('name'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('name') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="details" id="details" value="{{ old('details', $seat->details) }}">
