                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.seats.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="row" id="row" value="{{ old('row', '') }}" step="1" required>
                            @if($errors->has('row'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('row') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="column" id="column" value="{{ old('column', '') }}" step="1" required>
