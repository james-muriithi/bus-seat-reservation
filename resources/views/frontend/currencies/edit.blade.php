                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.currencies.update", [$currency->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="currency_symbol" id="currency_symbol" value="{{ old('currency_symbol', $currency->currency_symbol) }}" required>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="status" id="status" value="1" {{ $currency->status || old('status', 0) === 1 ? 'checked' : '' }}>
