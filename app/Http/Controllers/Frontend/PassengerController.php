...
class PassengerController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.passengers.index', compact('passengers'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.passengers.create');
    }
    ...
    public function store(StorePassengerRequest $request)
    {
        ...
        return redirect()->route('frontend.passengers.index');
    }
    ...
    public function edit(Passenger $passenger)
    {
        ...
        return view('frontend.passengers.edit', compact('passenger'));
    }
    ...
    public function show(Passenger $passenger)
    {
        ...
        return view('frontend.passengers.show', compact('passenger'));
    }
