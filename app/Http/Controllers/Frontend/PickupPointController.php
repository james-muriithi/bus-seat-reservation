...
class PickupPointController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.pickupPoints.index', compact('pickupPoints'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.pickupPoints.create', compact('routes'));
    }
    ...
    public function store(StorePickupPointRequest $request)
    {
        ...
        return redirect()->route('frontend.pickup-points.index');
    }
    ...
    public function edit(PickupPoint $pickupPoint)
    {
        ...
        return view('frontend.pickupPoints.edit', compact('routes', 'pickupPoint'));
    }
    ...
    public function show(PickupPoint $pickupPoint)
    {
        ...
        return view('frontend.pickupPoints.show', compact('pickupPoint'));
    }
