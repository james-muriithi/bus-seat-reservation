...
class BusRatingController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.busRatings.index', compact('busRatings'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.busRatings.create');
    }
    ...
    public function store(StoreBusRatingRequest $request)
    {
        ...
        return redirect()->route('frontend.bus-ratings.index');
    }
    ...
    public function edit(BusRating $busRating)
    {
        ...
        return view('frontend.busRatings.edit', compact('busRating'));
    }
    ...
    public function show(BusRating $busRating)
    {
        ...
        return view('frontend.busRatings.show', compact('busRating'));
    }
